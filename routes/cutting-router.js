...
router.get("/:id/pdf", async (req, res) => {
    try {
      ...
      doc.moveDown(0.5);
      doc.font("thai-bold").fontSize(14).text(`ช่วงวันที่: ${startDateStr} - ${endDateStr}`, 0, undefined);
      ...
      // ========== YIELD CENTER ========== //
      doc.moveDown(1);
      doc.font("thai-bold").fontSize(16).text(`ยอดสุทธิ: ${netTotal.toLocaleString()} บาท`, 0, undefined, centerOpts);
